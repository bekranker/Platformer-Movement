...
public class Movement2D : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (movementBehaviour.JumpDown == 1) _jumpBufferCounter = _jumpBufferLength;
        else _jumpBufferCounter -= Time.deltaTime;
        if (movementBehaviour.CancelDown == 1) _dashBufferCounter = _dashBufferLength;
    ...
    {
        return new Vector2(movementBehaviour.x, movementBehaviour.JumpDown);
    }
    ...
    private void FallMultiplier()
    {
        ...
        else
        {
            ...
            else if (_rb.velocity.y > 0 && GetInput().y == 0)
            {
